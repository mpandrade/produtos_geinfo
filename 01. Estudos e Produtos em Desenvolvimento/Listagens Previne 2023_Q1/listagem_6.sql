...
select 
	...
	has.inicio_quad,
	has.fim_quad,
	has.cd_usu_cadsus as hipertenso,
	uc.dt_nascimento,
	coalesce(pa.aferiu_pa,0) as pa_6m,
	coalesce(has.consulta_6m,0) as consulta_6m
from 
	hipertensos has
	left join afericao_pa pa on has.cd_usu_cadsus = pa.cd_usu_cadsus
	join usuario_cadsus uc on uc.cd_usu_cadsus = has.cd_usu_cadsus
