...
select
        sa.cd_solicitacao,
        case
        	when cr.cd_classificacao_risco = 0 then 'Vermelho'
        	when cr.cd_classificacao_risco = 1 then 'Amarelo'
        	when cr.cd_classificacao_risco = 2 then 'Verde'
        	when cr.cd_classificacao_risco = 3 then 'Azul'        	
