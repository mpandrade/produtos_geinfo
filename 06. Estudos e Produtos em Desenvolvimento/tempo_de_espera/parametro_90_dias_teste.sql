with 
	...
	where
        tp.ds_tp_procedimento like 'SMS%LABORAT%' -- APENAS PROCEDIMENTOS DAS FILAS DA SMS, FILTRADAS PELOS NOMES 
...
select 
	 ...
	 cd_usu_cadsus,
	 case 
		when '2022-09-01'::date < inclusao then 0
	 	when '2022-09-01'::date > agendamento then 0
		when (agendamento is not null and '2022-09-01'::date between inclusao and agendamento) 
			 or (agendamento is null and '2022-09-01'::date > inclusao) then 
	 			(case when ('2022-09-01'::date - inclusao) > 90 then 1 else 0 end)
	 else 0
