select
    ...
    sum(case when c.cod_cid = 420540 and sa.tp_consulta = 0 then 1 else 0 end) as Prim_consulta_Florianopolis,
    sum(case when c.cod_cid <> 420540 and sa.tp_consulta = 0 then 1 else 0 end) as Prim_consulta_outros_municipios,
    sum(case when c.cod_cid = 420540 and sa.tp_consulta = 1 then 1 else 0 end) as Retorno_Florianopolis,
    sum(case when c.cod_cid <> 420540 and sa.tp_consulta = 1 then 1 else 0 end) as Retorno_outros_municipios
from
